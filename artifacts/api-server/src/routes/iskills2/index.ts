...
// Parse Anthropic SKILL.md format (YAML frontmatter + markdown body)
function parseSkillMd(content: string): { name: string; description: string; instructions: string } | null {
